...
const Weather: React.FC = () => {
  ...
  // Placeholder data for city details (replace with actual API data)
  const cityDetails = {
    cityName: "London",
    history: [
      { date: "2023-11-01", temperature: 10, condition: "Cloudy" },
      { date: "2023-11-02", temperature: 12, condition: "Rainy" },
      { date: "2023-11-03", temperature: 15, condition: "Sunny" },
      { date: "2023-11-04", temperature: 13, condition: "Cloudy" },
      { date: "2023-11-05", temperature: 16, condition: "Sunny" },
    ],
    forecast: [
      { day: "Tomorrow", temperature: 14, condition: "Partly Cloudy" },
      { day: "Day After", temperature: 16, condition: "Sunny" },
      { day: "2 days after", temperature: 17, condition: "Sunny" },
      { day: "3 days after", temperature: 12, condition: "Rainy" },
      { day: "4 days after", temperature: 15, condition: "Partly Cloudy" },
    ],
  };
