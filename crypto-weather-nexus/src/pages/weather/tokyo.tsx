...
const TokyoWeather: React.FC = () => {
  ...
  // Placeholder data for Tokyo weather (replace with actual API data)
  const cityDetails = {
    cityName: "Tokyo",
    history: [
      { date: "2023-11-01", temperature: 15, condition: "Sunny" },
      { date: "2023-11-02", temperature: 16, condition: "Partly Cloudy" },
      { date: "2023-11-03", temperature: 18, condition: "Rainy" },
      { date: "2023-11-04", temperature: 14, condition: "Cloudy" },
      { date: "2023-11-05", temperature: 17, condition: "Sunny" },
    ],
    forecast: [
      { day: "Tomorrow", temperature: 19, condition: "Sunny" },
      { day: "Day After", temperature: 20, condition: "Partly Cloudy" },
      { day: "2 days after", temperature: 21, condition: "Sunny" },
      { day: "3 days after", temperature: 16, condition: "Rainy" },
      { day: "4 days after", temperature: 18, condition: "Partly Cloudy" },
    ],
  };
