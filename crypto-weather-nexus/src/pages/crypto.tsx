...
import { fetchCryptoDetails, fetchCryptoPrices, CryptoData, HistoricalPrice } from "../services/api";
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      >
        <div className="bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-4xl mb-8 mt-16">
          ...
          <div className="mb-6">
            <h2 className="text-2xl font-bold mb-4 text-gray-100">Select Cryptocurrency</h2>
              ...
              {["bitcoin", "ethereum", "dogecoin"].map((crypto) => (
                <button
                  ...
                  className={`p-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105 ${
                    selectedCrypto === crypto ? "bg-indigo-600 text-white" : "bg-gray-700 text-gray-300"
                  }`}
